...
module.exports = function(tickerResults, timeIndex){
    if(
        ...
        // console.log('bullish', timeIndex)
        tickerResults.divergence[timeIndex] = 1
    }else{
        // console.log('neutral', timeIndex)
    ...
    if(
        tickerResults.oversold.state[timeIndex][0][1] && 
        ...
        //     timeIndex, 
        //     tickerResults.oversold.state[timeIndex][1],
        //     tickerResults.price
        // )
